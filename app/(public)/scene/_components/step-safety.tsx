  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        {/* Road conditions — shown unconditionally so users know warning distance BEFORE placing sign */}
        ...
        {/* Warning distance result — shown as soon as all 3 dropdowns are filled */}
        {warningResult && (
